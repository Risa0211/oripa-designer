"""UPDATE_GUIDE.md → PDF（日本語対応・みんなのトレカブランディング）"""
...
md_path = ROOT / "UPDATE_GUIDE.md"
pdf_path = ROOT / "UPDATE_GUIDE.pdf"
...
.cover-title {
    font-size: 26pt; font-weight: 700; color: #1a1a1a; margin: 20px 0 12px;
}
...
<head>
<meta charset="UTF-8">
<title>みんなのトレカ オリパ商品設計ツール 追加機能ガイド</title>
<style>{CSS}</style>
</head>
<body>
<div class="cover">
    ...
    <div class="cover-sub">追加機能ガイド</div>
    <div class="cover-badge">v1.0 以降の新機能まとめ</div>
